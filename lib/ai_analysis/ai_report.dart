...
class _ChatPageState extends State<ReportPage> {
  ...
  //     print('${Get.put(AiController()).productName}');
  //     String userMessage =
  //         "The name of product is ${aiController.productName}, I need you to provide me response of only digit - 0, 1 or 2. Give me respone 0 if the product is bad for our health. Give me 1 if its okay to have sometimes if in moderation. Give me 2 if its healthy. The response should only be 0 1 or 2.";
